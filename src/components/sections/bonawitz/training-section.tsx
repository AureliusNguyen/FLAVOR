      ...
      <StepContent isActive={currentStep === 0} stepIndex={0}>
        <div className="space-y-6">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">Each client trains on their private data</p>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {clients.map((client, idx) => (
              ...
              >
                <Card className="border-2 bg-card/80" style={{ borderColor: client.color }}>
      ...
      <StepContent isActive={currentStep === 2} stepIndex={2}>
        <div className="space-y-6 pb-26">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">All clients have computed their gradient updates</p>
          </div>

          <Card className="bg-card border-border">
            <CardHeader>
              <CardTitle className="text-foreground">Gradient Vectors Ready</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {clients.map((client) => (
                  <div
                    key={client.id}
                    className="bg-muted p-3 rounded-lg border-l-4"
